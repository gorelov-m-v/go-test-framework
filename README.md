...
- [DSL](#dsl)
    - [HTTP](#http)
        ...
        - [Контрактное тестирование](#5-контрактное-тестирование-contract-testing)
    - [Database](#database)
...
- [Расширенные возможности](#расширенные-возможности)
    - [Шаги тестов (Step и AsyncStep)](#шаги-тестов-step-и-asyncstep)
        - [BaseSuite](#basesuite)
        - [Разница между Step и AsyncStep](#разница-между-step-и-asyncstep)
        - [Зачем нужен AsyncStep](#зачем-нужен-asyncstep)
        - [Конфигурация AsyncStep](#конфигурация-asyncstep)
...
### Шаги тестов (Step и AsyncStep)

Фреймворк предоставляет два типа шагов для организации тестов: синхронный `Step` и асинхронный `AsyncStep`. Оба метода доступны через `BaseSuite`.
...
#### Примеры использования AsyncStep
