...
- [DSL](#dsl)
    - [HTTP](#http)
        - [Сквозной E2E пример](#сквозной-e2e-пример-шаг-1---http-запрос)
        - [Справочник](#справочник-возможностей-dsl)
    - [Database](#database)
        - [Сквозной E2E пример](#сквозной-e2e-пример-шаг-2---проверка-в-бд)
        - [Справочник](#справочник-методов-db-dsl)
    - [Kafka](#kafka)
        - [Сквозной E2E пример](#сквозной-e2e-пример-шаг-3---проверка-события-в-kafka)
...
- [Расширенные возможности](#расширенные-возможности)
    ...
    - [OpenAPI Generator](#openapi-generator)
        - [Зачем это нужно](#зачем-это-нужно-4)
