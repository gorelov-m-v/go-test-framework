...
**AsyncStep** решает эту проблему автоматическими retry с умными стратегиями ожидания.
...
| **Использование** | Синхронные операции | Асинхронные операции |
| **Retry** | Нет | Есть (по конфигу) |
...
- Синхронные API запросы (GET /users/{id} должен вернуть 200 сразу)
- Проверки, которые должны пройти с первого раза
